...
try {
  ...
  const refreshExecutor = createDirectManualRunExecutor({
    ...
    settleMs: 0,
    adapterFactories: { codex: () => fakeAdapter({ attempt: refreshAttempt }) }
  });
...
function fakeAdapter({ exitCode = 0, running = false, attempt: providedAttempt = null } = {}) {
